	...
	useEffect(() => {
		...
		axios
			...
			.then((res) => {
				...
				setCheckout(new Date(2022, 5, 29, parseInt(temp2[0]), parseInt(temp2[1])) || '' || '');
			})
			.catch((error) => {
				console.log(error);
			});
		...
		<div className={`admin-panel ${toggled ? 'toggled' : ''} d-flex`}>
				...
				<div className="container py-5 px-lg-5">
					...
					<div className="container mt-4 p-4 edit-hotel-form border">
						<div className="mb-3 col-12">
							<div className="row mt-3">
								<div className="col-lg-2">
									<label for="exampleFormControlInput2" className="ms-2 mt-1 form-label" title="e1">
										Name
									</label>
								</div>
						...
						<div className="mb-3 col-12">
							<div className="row mt-3">
								<div className="col-lg-2">
									<label for="exampleFormControlInput2" className="ms-2 mt-1 form-label" title="e2">
										Header Picture
									</label>
								</div>
								<div className="col-lg-9">
						...
						<div className="mb-3 col-12">
							<div className="row">
								<div className="col-lg-2">
									<label for="exampleFormControlInput2" className="ms-2 mt-1 form-label" title="e3">
										Address
									</label>
								</div>
								<div className="col-lg-9">
            ...
            <hr class="dashed"></hr> */}
						...
						<div className="mb-3 col-12">
							<div className="row">
								<div className="col-lg-2">
									<label for="exampleFormControlInput2" className="ms-2 mt-1 form-label" title="e6">
										Time Range
									</label>
								</div>
								<div className="col-lg-9">
						...
						<div className="mb-3 col-12">
							<div className="row">
								<div className="col-lg-2">
									<label for="exampleFormControlInput3" className="ms-2 mt-1 form-label" title="e7">
										Phone Number
									</label>
								</div>
								<div className="col-lg-9">
						...
						<div className="mb-3 col-12">
							<div className="row">
								<div className="col-lg-2">
									<label for="exampleFormControlInput4" className="ms-2 mt-1 form-label" title="e8">
										Email
									</label>
								</div>
								<div className="col-lg-9">
						...
						<div className="mb-3 col-12">
							<div className="row">
								<div className="col-lg-2">
									<label for="exampleFormControlTextarea1" className="ms-2 form-label" title="e9">
										Description
									</label>
								</div>
								<div className="col-lg-9">
						...
						<div className="mb-3 col-12">
							<div className="row">
								<div className="col-lg-2">
									<label for="exampleFormControlTextarea1" className="ms-2 form-label" title="e10">
										Facilities
									</label>
								</div>
								<div className="col-lg-9">
