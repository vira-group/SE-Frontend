<div>
	<Carousel show={4}>
		<div className="m-2">
			{this.state.images ? (
				<img
					src={'http://127.0.0.1:8000' + this.state.images[0].image}
					className="img-fluid"
					alt="..."
		...
		<div className="m-2">
			{this.state.images ? (
				<img
					src={'http://127.0.0.1:8000' + this.state.images[1].image}
					className="img-fluid"
					alt="..."
					style={{ borderRadius: '20px' }}
				/>
		...
		<div className="m-2">
			{this.state.images ? (
				<img
					src={'http://127.0.0.1:8000' + this.state.images[2].image}
					className="img-fluid"
					alt="..."
					style={{ borderRadius: '20px' }}
				/>
		...
		<div className="m-2">
			{this.state.images ? (
				<img
					src={'http://127.0.0.1:8000' + this.state.images[3].image}
					className="img-fluid"
					alt="..."
					style={{ borderRadius: '20px' }}
				/>
		...
		<div className="m-2">
			{this.state.images ? (
				<img
					src={'http://127.0.0.1:8000' + this.state.images[4].image}
					className="img-fluid"
					alt="..."
					style={{ borderRadius: '20px' }}
				/>
		...
		<div className="m-2">
			{this.state.images ? (
				<img
					src={'http://127.0.0.1:8000' + this.state.images[5].image}
					className="img-fluid"
					alt="..."
					style={{ borderRadius: '20px' }}
				/>
		...
		<div className="m-2">
			{this.state.images ? (
				<img
					src={'http://127.0.0.1:8000' + this.state.images[6].image}
					className="img-fluid"
					alt="..."
					style={{ borderRadius: '20px' }}
				/>
		...
		<div className="m-2">
			{this.state.images ? (
				<img
					src={'http://127.0.0.1:8000' + this.state.images[7].image}
					className="img-fluid"
					alt="..."
					style={{ borderRadius: '20px' }}
				/>
		...
		<div className="m-2">
			{this.state.images ? (
				<img
					src={'http://127.0.0.1:8000' + this.state.images[8].image}
					className="img-fluid"
					alt="..."
					style={{ borderRadius: '20px' }}
				/>
