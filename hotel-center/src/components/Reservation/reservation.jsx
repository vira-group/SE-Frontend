...
class Reservation extends React.Component {
	...
	async componentDidMount() {
		...
		document.getElementById('pic1').src = (JSON.parse(localStorage.getItem('items'))[0].image)  ?  ('http://127.0.0.1:8000' + JSON.parse(localStorage.getItem('items'))[0].image)  : 
		...
		;
		document.getElementById('pic2').src = 'http://127.0.0.1:8000' + JSON.parse(localStorage.getItem('items'))[1].image  ;
		document.getElementById('pic3').src = 'http://127.0.0.1:8000' + JSON.parse(localStorage.getItem('items'))[2].image  ;
		document.getElementById('pic4').src = 'http://127.0.0.1:8000' + JSON.parse(localStorage.getItem('items'))[3].image  ;
		document.getElementById('pic5').src = 'http://127.0.0.1:8000' + JSON.parse(localStorage.getItem('items'))[0].image  ;
		document.getElementById('pic6').src = 'http://127.0.0.1:8000' + JSON.parse(localStorage.getItem('items'))[1].image  ;
		document.getElementById('pic7').src = 'http://127.0.0.1:8000' + JSON.parse(localStorage.getItem('items'))[2].image  ;
		document.getElementById('pic8').src = 'http://127.0.0.1:8000' + JSON.parse(localStorage.getItem('items'))[3].image  ;
		...
		document.getElementById("person").innerHTML =  (parseInt(JSON.parse(localStorage.getItem('i1')).split('T')[0][2]) -parseInt(JSON.parse(localStorage.getItem('i1')).split('T')[0][2]) +1) * parseInt(this.state.price_per_day)+ "$" ;
