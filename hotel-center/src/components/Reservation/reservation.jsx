						...
						>
							...
							<div className="carousel-inner">
								<div className="carousel-item active">
									<img
										src={'http://127.0.0.1:8000' + JSON.parse(localStorage.getItem('items'))[0].image}
								...
								<div className="carousel-item">
									<img
										style={{ borderRadius: '50px' }}
										src={'http://127.0.0.1:8000' + JSON.parse(localStorage.getItem('items'))[1].image}
								...
								<div className="carousel-item">
									<img
										src={'http://127.0.0.1:8000' + JSON.parse(localStorage.getItem('items'))[2].image}
								...
								<div className="carousel-item">
									<img
										src={'http://127.0.0.1:8000' + JSON.parse(localStorage.getItem('items'))[3].image}
